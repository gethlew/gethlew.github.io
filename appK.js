...
class App{
    ...
    setupXR(){
        ...
        this.gestures.addEventListener('rotate' , (ev)=>{
            console.log(ev);
            if (ev.initialise !== undefined){
                self.startQuaterinion = self.knight.object.quaternion.clone();
            }else{
                self.knight.object.quaternion.copy(self.startQuaterinion);
                self.knight,object.rotateY(ev.theta);
                self.ui.updateElement('info','rotate ${ev.theta.tpFixed(3)})');
            }
        })
