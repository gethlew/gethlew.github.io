	...
	constructor( renderer ) {
        ...
        if ( 'xr' in navigator ) {
            ...
            if (window.isSecureContext === false ){
                message.href = document.location.href.replace(/^http:/,'htttps:');
	...
	showEnterVR( button ) {
        ...
        button.onclick = function(){
            if ( currentSession === null){
                ...
                navigator.xr.requestSession('imersive-vr', sessionInit).then(onSessionStarted);
            }else{
                currentSession.end();
            }
        }
